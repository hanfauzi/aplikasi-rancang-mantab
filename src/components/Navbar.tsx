            ...
            <div className="hidden md:flex items-center gap-8">
              {navItems.map((item) => (
                <a
                  ...
                  className="text-[#052B63] cursor-pointer hover:text-[#024FC5] font-semibold text-base transition-colors duration-200"
                >
                  {item.label}
                </a>
              ))}
              <button
                ...
                className="text-white bg-[#024FC5] hover:bg-[#024FC5]/70 cursor-pointer font-semibold rounded-lg px-6 py-2.5 transition-colors duration-200"
              >
                Hubungi Kami
              </button>
            </div>
            ...
            <div className="px-6 pt-6 pb-8">
              ...
              <ul className="space-y-5 font-semibold text-base text-[#0E1D1B]">
                {navItems.map((item) => (
                  <li
                    key={item.target}
                    className="hover:text-[#004740] transition-colors cursor-pointer"
                  >
                    <a
                      onClick={() => handleScrollTo(item.target)}
                      className="block"
